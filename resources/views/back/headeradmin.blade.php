...
<head>
    <base href="">
    <meta charset="utf-8"/>
    <title>@yield('webtitleadmin')</title>
    <meta name="description" content="Updates and statistics"/>
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"/>
    <link href="{{url('/admin/css/googlefont.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{url('/admin/css/app.css')}}" rel="stylesheet" type="text/css"/>
    ...
    <link href="{{url('/admin/css/plugins/custom/datatables/datatables.bundle.rtl.css')}}" rel="stylesheet" type="text/css"/>
