    ...
    <div class="card card-custom card-stretch gutter-b card-shadowless bg-light">
        ...
        <div class="card-header border-0 py-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label font-weight-bolder text-dark">مدیریت تبلیغ</span>

            </h3>
            <div class="card-toolbar">
                <a href="{{route('admin.adver.create')}}" class="btn btn-success font-weight-bolder font-size-sm">
            ...
            <div class="table-responsive">
                <table class="table table-head-custom table-vertical-center table-bordered text-center" id="kt_advance_table_widget_1">
                    ...
                    <tr class="text-center">
                        ...
                        <th style="min-width: 200px">شعار تبلیغ</th>


                        <th style="min-width: 100px">جایگاه</th>
                    ...
                    @foreach($advers as $adver)
                        @switch($adver->place)
                            @case(1)
                            @php $place="جایگاه اول";
                            $badgecolorplace='badge-info';
                            $badgecolorplace1='badge-white';@endphp
                            @break

                            @case(0)
                            @php $place="جایگاه دوم";
                            $badgecolorplace='badge-primary';
                            $badgecolorplace1=' ';
                        ...
                        <tr>
                            ...
                            <td class="pr-0">
                                ...
                                <span class="symbol-label">
                                    <img src="{{url('/images/adver/thumb/'.$adver->image)}}" class="h-75 align-self-end" alt="{{$adver->name}}">
                                </span>
                                </div>
                            </td>
                            <td class="pl-0">
...
<td class="pl-0">
                            ...
                            <td class="pl-0">
                                <a href="{{route('statuschangeadver',$adver->id)}}" class="badge  {{$badgecolorstatus}} ">
                                    {{$status}}
...
<td class="pl-0">
                            ...
                            <td class="pr-0 text-center">
                                ...
                                <a href="{{route('admin.adver.edit',$adver->id)}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M12.9,2 C13.4522847,2 13.9,2.44771525 13.9,3 C13.9,3.55228475 13.4522847,4 12.9,4 L6,4 C4.8954305,4 4,4.8954305 4,6 L4,18 C4,19.1045695 4.8954305,20 6,20 L18,20 C19.1045695,20 20,19.1045695 20,18 L20,13 C20,12.4477153 20.4477153,12 21,12 C21.5522847,12 22,12.4477153 22,13 L22,18 C22,20.209139 20.209139,22 18,22 L6,22 C3.790861,22 2,20.209139 2,18 L2,6 C2,3.790861 3.790861,2 6,2 L12.9,2 Z"
              fill="#000000" fill-rule="nonzero" opacity="0.3"></path>
                                ...
                                <a href="{{route('admin.adver.delete',$adver->id)}}" onclick="return confirm('آیا تبلیغ حذف شود؟');" class="btn btn-icon btn-light btn-hover-primary btn-sm">
