    ...
    <div class="card card-custom card-stretch gutter-b card-shadowless bg-light">
        ...
        <div class="card-header border-0 py-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label font-weight-bolder text-dark">مدیریت کاربران</span>
                <span class="text-muted mt-3 font-weight-bold font-size-sm">تعداد کاربران </span>
            </h3>
                ...
                <table class="table table-head-custom table-vertical-center table-bordered text-center" id="kt_advance_table_widget_1">
                    ...
                    @foreach($users as $user)
                        @switch($user->role)
                            ...
                            @case(2)
                            @php $role="عادی";
                            $badgecolorrole='badge-info'; @endphp
                            @break

                            @case(3)
                            @php $role="ویژه";
                            $badgecolorrole='badge-success'; @endphp
                            @break
                        ...
                        @switch($user->status)
                            ...
                            @case(1)
                            @php $status="فعال";
                            $badgecolorstatus='badge-success'; @endphp
                            @break

                            @case(0)
                            @php $status="غیرفعال";
                            $badgecolorstatus='badge-danger'; @endphp
                            @break

                            @case(2)
                            @php $status="بلاک";
                            $badgecolorstatus='badge-dark'; @endphp
                            @break
                        ...
                        <tr>
                            ...
                            <td class="pl-0">
                                <label class="badge  {{$badgecolorrole}} ">
                                    {{$role}}
                            ...
                            <td class="pl-0">
                                ...
                                <a href="{{route('statuschange',$user->id)}}" class="badge  {{$badgecolorstatus}} ">
                                    {{$status}}
                            ...
                            <td class="pr-0 text-center">
                                ...
                                <a href="{{route('adminprofile',$user->id)}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M12.9,2 C13.4522847,2 13.9,2.44771525 13.9,3 C13.9,3.55228475 13.4522847,4 12.9,4 L6,4 C4.8954305,4 4,4.8954305 4,6 L4,18 C4,19.1045695 4.8954305,20 6,20 L18,20 C19.1045695,20 20,19.1045695 20,18 L20,13 C20,12.4477153 20.4477153,12 21,12 C21.5522847,12 22,12.4477153 22,13 L22,18 C22,20.209139 20.209139,22 18,22 L6,22 C3.790861,22 2,20.209139 2,18 L2,6 C2,3.790861 3.790861,2 6,2 L12.9,2 Z"
              fill="#000000" fill-rule="nonzero" opacity="0.3"></path>
                                ...
                                <a href="{{route('adminuserdelete',$user->id)}}" onclick="return confirm('آیا کاربر حذف شود؟');" class="btn btn-icon btn-light btn-hover-primary btn-sm">
